...
public class ConstantUtil {
    ...
    public static final String INPUT_FOLDER = TEST_FILES_PATH + "input\\";

    public static final String CERT_FILE = INPUT_FOLDER + "temp.pfx";
    public static final String CERT_PASSWORD = "12345";

    public static final String INPUT = INPUT_FOLDER + "input" + EXTENSION;
    ...
    public static final String OUTPUT_MERGE = TEST_FILES_PATH + "Merged" + EXTENSION;
    public static final String OUTPUT_WITH_IMAGE = TEST_FILES_PATH + "WithImage" + EXTENSION;
    public static final String OUTPUT_TEXT_TO_FORM_FIELDS = TEST_FILES_PATH + "TextToFormFields" + EXTENSION;
